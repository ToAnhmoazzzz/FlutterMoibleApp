            ...
            Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    //     Expanded(
                    //       child: Text(
                    //         "+ ${(widget.mObj.deliverPrice ?? 0).toStringAsFixed(2)}VND",
                    //         textAlign: TextAlign.right,
                    //         style: TextStyle(
                    //             color: TColor.primaryText,
                    //             fontSize: 18,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "- ${(widget.mObj.discountPrice ?? 0).toStringAsFixed(2)}VND",
                            textAlign: TextAlign.right,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "${(widget.mObj.userPayPrice ?? 0).toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match match) => '${match[1]},')} đ",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                              color: TColor.primaryText,
                              fontSize: 22,
