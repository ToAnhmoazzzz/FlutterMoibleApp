                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Obx(
                        () {
                          // Chuyển đổi giá trị từ String sang double (hoặc int) trước khi sử dụng toStringAsFixed
                          final price = double.tryParse(detailVM.getPrice());
                          if (price != null) {
                            return Text(
                              "${price.toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match match) => '${match[1]},')} đ",
                              style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 24,
                                fontWeight: FontWeight.w700,
                            ...
                            return Text(
                              "Invalid price", // Xử lý trường hợp giá không hợp lệ
                              style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 24,
                                fontWeight: FontWeight.w700,
